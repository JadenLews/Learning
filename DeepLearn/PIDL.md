...
## Abstract
* NN that trained to solve supervised tasks while respecting any given law of physics described by general linlinear partial differential equations.
* Two distict classes of algorithms:
  * Continious time
  * Discrete Time
* Form a new class of data-efficient universal function approximators
